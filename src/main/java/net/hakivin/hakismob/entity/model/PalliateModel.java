package net.hakivin.hakismob.entity.model;
...
@OnlyIn(Dist.CLIENT)
public class PalliateModel extends HierarchicalModel<Palliate> implements ArmedModel {
    ...
    public PalliateModel(ModelPart pRoot) {
     ...
     */
    public void setupAnim(Palliate pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
