...
public abstract class IceShard extends AbstractHurtingProjectile implements ItemSupplier {
    ...
    public IceShard(EntityType<? extends IceShard> pEntityType, double pX, double pY, double pZ, double pOffsetX, double pOffsetY, double pOffsetZ, Level pLevel) {
        super(pEntityType, pX, pY, pZ, pOffsetX, pOffsetY, pOffsetZ, pLevel);
    }

    public IceShard(EntityType<? extends IceShard> pEntityType, LivingEntity pShooter, double pOffsetX, double pOffsetY, double pOffsetZ, Level pLevel) {
        super(pEntityType, pShooter, pOffsetX, pOffsetY, pOffsetZ, pLevel);
    }

    public void setItem(ItemStack pStack) {
        if (!pStack.is(Items.SNOWBALL) || pStack.hasTag()) {
